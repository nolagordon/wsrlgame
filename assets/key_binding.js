...
Game.KeyBinding.BindingSet.numpad.PERSISTENCE_SAVE = {label:'s' ,inputMatch:ROT.VK_S ,inputType:'keydown'  ,inputMetaShift:false  ,inputMetaCtrl:false};
Game.KeyBinding.BindingSet.numpad.PERSISTENCE_LOAD = {label:'l' ,inputMatch:ROT.VK_L ,inputType:'keydown'  ,inputMetaShift:false  ,inputMetaCtrl:false};
Game.KeyBinding.BindingSet.numpad.PERSISTENCE_NEW  = {label:'n' ,inputMatch:ROT.VK_N ,inputType:'keydown'  ,inputMetaShift:false  ,inputMetaCtrl:false};
